...
import { toOpenAITool, fromOpenAICompletion, normalizeFinishReason, buildOpenAIMessageList, getOpenAIReasoningText, repairToolArgs, } from './openai-common.js';
...
export class OpenAIAdapter {
    ...
    buildMessageOptions(options) {
        ...
        if (!wantsNativeEcho && !wantsTextFallback)
            return undefined;
        return {
