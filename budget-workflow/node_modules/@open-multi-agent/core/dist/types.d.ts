 ...
 */
export type AcpPermissionPolicy = 'auto-approve' | 'reject' | ((request: AcpPermissionRequest) => boolean | Promise<boolean>);
/**
...
export type TraceEventType = 'llm_call' | 'tool_call' | 'task' | 'agent' | 'plan_ready' | 'agent_stream' | 'consensus';
...
export type TraceEvent = LLMCallTrace | ToolCallTrace | TaskTrace | AgentTrace | PlanReadyTrace | AgentStreamTrace | ConsensusTrace;
/** JSON-serializable value accepted by {@link SharedMemory}. */
export type SharedMemoryValue = string | number | boolean | null | readonly SharedMemoryValue[] | {
