 ...
 */
import type { Task, TaskQueueSnapshot, TaskStatus } from '../types.js';
...
export declare class TaskQueue {
     ...
     */
    static fromSnapshot(snapshot: TaskQueueSnapshot, options?: {
    ...
    private requireTask;
    private static taskToSnapshot;
    private static taskFromSnapshot;
    private static parseSnapshotDate;
    private static resetRestoredInProgress;
}
export {};
