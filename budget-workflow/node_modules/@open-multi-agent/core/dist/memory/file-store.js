...
export class FileStore {
    ...
    async load() {
        ...
        try {
            ...
            throw new Error(`FileStore: state file at "${this.filePath}" is not valid JSON. ` +
    ...
    static assertStoreFile(value, path) {
        if (value === null || typeof value !== 'object' || Array.isArray(value)) {
            throw new Error(`FileStore: state file at "${path}" is not a store object.`);
        }
        const obj = value;
        if (obj['version'] !== FILE_FORMAT_VERSION) {
            throw new Error(`FileStore: unsupported state file version ${String(obj['version'])} at "${path}" ` +
